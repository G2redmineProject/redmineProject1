...
public interface DocsMapper {
	...
	// 문서 단건 조회(파일 다운로드용)
	public DocsVO selectFileByCode(Integer fileCode);
	
	// 폴더 내 모든 파일 조회 하위 폴더 포함(폴더 다운로드용)
	public List<DocsVO> selectFilesByFolder(Integer folderCode);
	
	// 파일 삭제
	public int deleteFile(Integer fileCode);
	...
	// 폴더 삭제
	public int deleteFolder(Integer folderCode);
}
