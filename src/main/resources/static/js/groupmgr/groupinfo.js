...
function addSelectedMembers() {
    ...
    checked.forEach(cb => {
        ...
        tr.innerHTML = `
            <td><a href="/users/${userCode}" class="user-link text-decoration-none">${cb.dataset.userName}</a></td>
            <td>${cb.dataset.userEmail || ''}</td>
            <td><button type="button" class="btn btn-danger btn-sm" onclick="removeNewMember(this, ${userCode})">
